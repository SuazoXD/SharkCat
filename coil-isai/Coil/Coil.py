...
# Inicializar el m�dulo de dibujo de Mediapipe
mp_drawing = mp.solutions.drawing_utils

# Funci�n para calcular �ngulos entre tres puntos
...
def connect_db():
    try:
        conn = pyodbc.connect(
            ...
            'SERVER=DESKTOP-L3S0G6J\SQLEXPRESS;'
            'DATABASE=Usuarios;'
            'UID=stefany;'
            'PWD=oracle'
        )
...
while cap.isOpened():
    ...
    # Convertir el frame a RGB (porque Mediapipe trabaja con im�genes RGB)
    ...
    if results.pose_landmarks:
        ...
        # C�lculo del �ngulo en las rodillas (para agacharse)
        ...
        # C�lculo del �ngulo en los hombros (para levantar los brazos)
        ...
        # Dibujar l�neas adicionales para mostrar la alineaci�n del cuerpo
